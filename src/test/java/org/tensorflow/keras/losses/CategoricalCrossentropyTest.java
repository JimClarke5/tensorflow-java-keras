...
public class CategoricalCrossentropyTest {
    ...
    public void testConfig() {
        ...
        instance = new CategoricalCrossentropy("catx_1", Reduction.SUM);
    ...
    public void test_scalar_weighted() {
        ...
        try ( Graph graph = new Graph();  Session sess = new Session(graph)) {
            ...
            Operand logits = tf.reshape(tf.constant(logits_np), tf.constant(Shape.of(3, 3)));
            instance = new CategoricalCrossentropy(true);
            loss = instance.call(tf, y_true, logits, sampleWeight);
            sess.run(loss);
    ...
    public void test_label_smoothing() {
        ...
        try ( Graph graph = new Graph();  Session sess = new Session(graph)) {
            ...
            CategoricalCrossentropy instance = new CategoricalCrossentropy(true, label_smoothing);
            Operand loss = instance.call(tf, y_true, logits);
